...
export class ProductosController {
    ...
    constructor(readonly createUser: CreateUser, readonly getuser: GetUser, readonly getuserid: GetUserid, readonly deluserid: DelUserId, readonly putuser: PutUser) { }
